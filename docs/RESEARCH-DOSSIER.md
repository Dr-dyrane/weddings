...
**Adapt:** the crest becomes the couple's own approved mark; gilded edges become controlled light response; calligraphy is used for one ceremonial accent, not paragraphs.
