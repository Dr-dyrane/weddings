...
It is a concept reference, not a production-ready logo master.

Source record:

- supplied by the user on 8 August 2026;
- original filename: `CBDEA532-204C-40D1-B39F-37ED0E6C86EE.jpeg`;
- dimensions: 1408 × 768 px;
- SHA-256: `c7d3867dfb2d2704fccd1622132e4e8be38c6cd6e1428994dfe23d901bdb98b8`;
- rights state: user-supplied concept; production ownership and any underlying source must be confirmed before commercial reuse.
...
- clear-space, minimum-size, contrast and misuse rules.

The mark should survive without gradients. Foil, lighting and depth are applications of the mark, not structural requirements.
